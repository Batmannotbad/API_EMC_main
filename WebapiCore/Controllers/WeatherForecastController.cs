...
namespace WebapiCore.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("chiSoTheoDonViTheoThang")]
        public async Task<IActionResult> GetChiSoDonViTheoThang([FromBody] ChiSoDonViRequest request)
        {
            var OBAL = new BAL.GetDataBAL(_dapper);
            var dt = new Object();
            if (TokenHelper.ValidationToken(request.Token))
            {
                ...
                var bangLuyKeRecords = await OBAL.ChiSoTheoDonViTheoThang(YearMonitor, TinhDiaPhuong, ChiSo, MonthMonitor);
        ...
        [HttpPost]
        [Route("blkMienTheoThang")]
        public async Task<IActionResult> GetBlkMienTheoThang([FromBody] BangLuyKeVungMien request)
        {
            var OBAL = new BAL.GetDataBAL(_dapper);
            var dt = new Object();
            if (TokenHelper.ValidationToken(request.Token))
            {
                ...
                var bangLuyKeRecords = await OBAL.GetBangLuyKeMienTheoThang(YearMonitor, MonthMonitor);
        ...
        [HttpPost]
        [Route("blkVungTheoThang")]
        public async Task<IActionResult> GetBlkVungTheoThang([FromBody] BangLuyKeVungMien request)
        {
            var OBAL = new BAL.GetDataBAL(_dapper);
            var dt = new Object();
            if (TokenHelper.ValidationToken(request.Token))
            {
                ...
                var bangLuyKeRecords = await OBAL.GetBlkVungTheoThang(YearMonitor, MonthMonitor);
        ...
        [HttpPost]
        [Route("GetblkTheoThang")]
        public async Task<IActionResult> GetBlkTheoThang([FromBody] BangLuyKeTheoThang request)
        {
            var OBAL = new BAL.GetDataBAL(_dapper);
            var dt = new Object();
            if (TokenHelper.ValidationToken(request.Token))
            {
                ...
                var bangLuyKeRecords = await OBAL.GetBlkTheoThang(YearMonitor, MonthMonitor, SiteID);
